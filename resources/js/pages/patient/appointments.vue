        ...
        <VCardText>
          ...
          >
                    ...
                    <VRow>
                      ...
                      >
                        ...
                        <div v-if="slotProps.item.link">
                          <a :href="slotProps.item.link">{{ slotProps.item.link }}</a>
                        </div>
                        <div v-else>
                          <VAlert
                            color="light-warning"
                          ...
                          >
                            <p class="mb-0">
                              Doctor has Not yet created link for consultation.
                            </p>
                          </VAlert>
                        </div>
                      </VCol>
            ...
            <template #item.name="{ item }">
              <div class="d-flex align-center">
                <VAvatar
                  ...
                  variant="tonal"
                >
                  <span>{{ avatarText(item.raw.doctor.name) }}</span>
                </VAvatar>
                <div class="d-flex flex-column ms-3">
                  <span class="d-block font-weight-medium text--primary text-truncate">{{ item.raw.doctor.name }}</span>
                </div>
              </div>
            </template>
            <template #item.email="{ item }">
              <div class="d-flex align-center">
                <div class="d-flex flex-column ms-3">
                  <span class="d-block font-weight-medium text--primary text-truncate">{{ item.raw.doctor.email }}</span>
                </div>
              </div>
            </template>
