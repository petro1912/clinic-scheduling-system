...
<body>
  ...
  <section data-bs-version="5.1" class="header18 cid-ucfBvxtpNH mbr-fullscreen"
    data-bg-video="https://www.youtube.com/embed/0EW_k1A0zPc?autoplay=1&amp;loop=1&amp;playlist=0EW_k1A0zPc&amp;t=20&amp;mute=1&amp;playsinline=1&amp;controls=0&amp;showinfo=0&amp;autohide=1&amp;allowfullscreen=true&amp;mode=transparent"
    id="hero-16-ucfBvxtpNH">
  ...
  <section data-bs-version="5.1" class="article9 cid-ucfBvxuu9r" id="about-us-9-ucfBvxuu9r">
  ...
  <section data-bs-version="5.1" class="list05 cid-ucfBvxuMS1" id="faq-3-ucfBvxuMS1">
          ...
          <div class="item features-without-image col-12 active">
            <div class="item-wrapper">
              <h5 class="mbr-card-title mbr-fonts-style mt-0 mb-3 display-5">
                <strong>How does TeleMedicina simplify registrations?</strong>
              </h5>
              <p class="mbr-text mbr-fonts-style mt-0 mb-3 display-7">TeleMedicina streamlines the registration process by
                eliminating paperwork and automating appointment scheduling, saving you time and hassle.</p>
            </div>
          </div>
          <div class="item features-without-image col-12">
            <div class="item-wrapper">
              <h5 class="mbr-card-title mbr-fonts-style mt-0 mb-3 display-5">
                <strong>Is TeleMedicina compatible with all devices?</strong>
              </h5>
              <p class="mbr-text mbr-fonts-style mt-0 mb-3 display-7">Yes, TeleMedicina is designed to be responsive and
                accessible on all devices, ensuring a seamless experience whether you're on a computer, tablet, or
                smartphone.</p>
            </div>
          </div>
          <div class="item features-without-image col-12">
            <div class="item-wrapper">
              <h5 class="mbr-card-title mbr-fonts-style mt-0 mb-3 display-5">
                <strong>Can I customize my scheduling preferences on TeleMedicina?</strong>
              </h5>
              <p class="mbr-text mbr-fonts-style mt-0 mb-3 display-7">Absolutely! TeleMedicina allows you to personalize
                your scheduling preferences, including appointment times, reminders, and notifications, tailored to your
                needs.</p>
            </div>
          </div>
          <div class="item features-without-image col-12">
            <div class="item-wrapper">
              <h5 class="mbr-card-title mbr-fonts-style mt-0 mb-3 display-5">
                <strong>How secure is my data on TeleMedicina?</strong>
              </h5>
              <p class="mbr-text mbr-fonts-style mt-0 mb-3 display-7">Rest assured, TeleMedicina prioritizes data security
                and confidentiality. Your information is encrypted and protected with the highest standards of security
                measures in place.</p>
            </div>
          </div>
          <div class="item features-without-image col-12">
            <div class="item-wrapper">
              <h5 class="mbr-card-title mbr-fonts-style mt-0 mb-3 display-5">
                <strong>What support options are available with TeleMedicina?</strong>
              </h5>
              <p class="mbr-text mbr-fonts-style mt-0 mb-3 display-7">TeleMedicina offers 24/7 customer support to assist
                you with any queries or issues you may have. Our dedicated team is here to ensure your experience with
                TeleMedicina is smooth and hassle-free.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container-fluid gallery-wrapper">
      ...
      <div class="grid-container">
        <div class="grid-container-3 moving-left" style="transform: translate3d(-200px, 0px, 0px);">
          <div class="grid-item">
            <img src="assets/images/photo-1606811841689-23dfddce3e95.jpeg" alt="Mobirise Website Builder">
          </div>
          <div class="grid-item">
            <img src="assets/images/photo-1612277795054-a7a98257dd6d.jpeg" alt="Mobirise Website Builder">
          </div>
          <div class="grid-item">
            <img src="assets/images/photo-1567745566980-4378a3db17fc.jpeg" alt="Mobirise Website Builder">
          </div>
          <div class="grid-item">
            <img src="assets/images/photo-1612277795122-9d3c6ca381d6.jpeg" alt="Mobirise Website Builder">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="card col-md-12 col-lg-10">
          <div class="card-wrapper">
            <h3 class="card-title mbr-fonts-style mbr-white mt-3 mb-4 display-2">
              <strong>Revolutionize Your Clinic</strong>
            </h3>
            <div class="row card-box align-left">
              <div class="item features-without-image col-12">
                <div class="item-wrapper">

                  <p class="mbr-text mbr-fonts-style display-7">Welcome to the future of clinical registration and
                    scheduling! Say goodbye to the chaos of paperwork and endless phone calls.</p>
                </div>
              </div>
              <div class="item features-without-image col-12">
                <div class="item-wrapper">

                  <p class="mbr-text mbr-fonts-style display-7">Our cutting-edge system streamlines the entire process,
                    making appointments a breeze for both your staff and patients.</p>
                </div>
              </div>
              <div class="item features-without-image col-12">
                <div class="item-wrapper">

                  <p class="mbr-text mbr-fonts-style display-7">Join us in the journey to efficiency and excellence in
                    healthcare management. Let's make your clinic the talk of the town!</p>
                </div>
              </div>
            </div>
      ...
      <div class="row ">
        <div class="col-12 col-lg-8">
          <div class="image-wrapper mb-4">
            <img class="w-100" src="assets/images/photo-1606318313647-137d1f3b4d3c.jpeg" alt="Mobirise Website Builder">
          </div>

        </div>
        <div class="col-12 col-lg">
          <p class="mbr-side-description mbr-fonts-style mb-4 align-center display-7">Experience the power of our
          Health-oriented Clinical Registration platform. From intuitive scheduling to team collaboration, we've got you covered for a
            smoother clinic operation.</p>
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="col-lg-10 mbr-form">
          <div class="col-lg-12 col-md-12 col-sm-12">
            <h5 class="mbr-section-title mbr-fonts-style mb-5 display-2">
              <strong>Revolutionize Your Clinical Experience Today!</strong>
            </h5>
          </div>
          ...
          <div class="text-wrapper align-left" data-form-type="formoid">
            <form action="https://mobirise.eu/" method="POST" class="mbr-form form-with-styler"
              data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true"
                value="bwYHb9P58e4DN3zcN6/sW4PSCh23xBM8FkuSjr8jPd+QTHt9NedcoPRbGx2Jgf41B3HFczfTVnv8NGz3tQLakCuUzWD00A1JvGDl3WcbMniXu8TLRpOe+1rBLtBexx1M">
              <div class="row">
              ...
              <div class="dragArea row">
                <div data-for="email" class="col-lg-6 col-md-6 col-sm-12 form-group">
                  <input type="email" name="email" placeholder="test@email.com" data-form-field="email"
                    class="form-control display-7" value="" id="email-call-to-action-12-ucfBvxzP6o">
                </div>
                <div class="col-auto mbr-section-btn">
                  <button type="submit" class="w-100 btn btn-primary display-7">Get Started Now</button>
                </div>
              </div>
            </form>
          </div>
  ...
  <section data-bs-version="5.1" class="people05 cid-ucfBvxzddv" id="testimonials-6-ucfBvxzddv">
    ...
    <div class="container">
      <div class="row mb-5 justify-content-center">
        <div class="col-12 mb-0 content-head">
          <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2"><strong>Testinominal</strong></h3>
      ...
      <div class="row">
        <div class="item features-without-image col-12 col-md-6 col-lg-4 active">
          <div class="item-wrapper">
            <div class="card-box align-left">
              <p class="card-text mbr-fonts-style display-7">This system is a game-changer! Scheduling made easy and
                efficient.</p>
              <div class="img-wrapper mt-4 mb-3">
                <img src="assets/images/photo-1543965170-4c01a586684e.jpeg" alt="" data-slide-to="0"
                  data-bs-slide-to="0">
              </div>
        ...
        <div class="item features-without-image col-12 col-md-6 col-lg-4">
          <div class="item-wrapper">
            <div class="card-box align-left">
              <p class="card-text mbr-fonts-style display-7">Incredible! I can't imagine my practice without it.</p>
              <div class="img-wrapper mt-4 mb-3">
                <img src="assets/images/photo-1546919057-eae69a7a3c35.jpeg" data-slide-to="1" data-bs-slide-to="1"
                  alt="">
              </div>
              <h5 class="card-title mbr-fonts-style display-7">
        ...
        <div class="item features-without-image col-12 col-md-6 col-lg-4">
          <div class="item-wrapper">
            <div class="card-box align-left">
              <p class="card-text mbr-fonts-style display-7">Life-saving tool for any clinic. A must-have!</p>
              <div class="img-wrapper mt-4 mb-3">
                <img src="assets/images/photo-1536548665027-b96d34a005ae.jpeg" data-slide-to="2" data-bs-slide-to="2"
                  alt="">
              </div>
              <h5 class="card-title mbr-fonts-style display-7">
  ...
  <section data-bs-version="5.1" class="features023 cid-ucfBvxBPt8" id="metrics-1-ucfBvxBPt8">
      ...
      <div class="row content-row justify-content-center">
        ...
        <div class="item features-without-image col-12 col-md-6 col-lg-4 item-mb">
          <div class="item-wrapper">
            ...
            <h4 class="card-title mbr-fonts-style display-5">
              <strong>Clinics Registered</strong>
            </h4>
  ...
  <section data-bs-version="5.1" class="social4 cid-ucfBvxC6O5" id="follow-us-1-ucfBvxC6O5">
  ...
  <section data-bs-version="5.1" class="form5 cid-ucfBvxE1yi" id="contact-form-2-ucfBvxE1yi">
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8 mx-auto mbr-form" data-form-type="formoid">
          <form action="https://mobirise.eu/" method="POST" class="mbr-form form-with-styler"
            data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true"
              value="ZbKtiJUXg2t9Rw8ITKQYx9xD51ION6Eiuq0TRYbS96iq9334e1OGaObUcR4PYBIJVuWM+9gqT3tugn7UwYjBsOdRZPuWCEDkUbbhAFiv6enTd2p+l4VA+ThhWtcxzS1S">
            <div class="row">
              <div hidden="hidden" data-form-alert="" class="alert alert-success col-12">Thanks for filling out the
                form!</div>
              <div hidden="hidden" data-form-alert-danger="" class="alert alert-danger col-12">
  ...
  <section data-bs-version="5.1" class="contacts02 map1 cid-ucfBvxEMGf" id="contacts-2-ucfBvxEMGf">
            ...
            <div class="text-wrapper">
              ...
              <ul class="list mbr-fonts-style display-7">
                <li class="mbr-text item-wrap">
                  Phone:
                  <a href="tel:1-800-CLINICAL" class="text-black">1-800-CLINICAL</a>
                </li>
                ...
                <li class="mbr-text item-wrap">
                  Email:
                  <a href="mailto:info@clinicalregistration.com" class="text-black">info@clinicalregistration.com</a>
                </li>
  ...
  <section data-bs-version="5.1" class="footer3 cid-ucfBvxEXLt" once="footers" id="footer-3-ucfBvxEXLt">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-12 mt-5">
          <p class="mbr-fonts-style copyright display-7">© 2024 Clinical Registration. All Rights Reserved.</p>
        </div>
      </div>
    </div>
  </section>
